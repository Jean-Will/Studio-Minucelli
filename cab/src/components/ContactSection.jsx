    ...
    <section id="contact" className="py-6 bg-slate-50">
        <div className="max-w-5x1 mx-auto px-4">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                {/* whatsapp */}
                <div className="rounded-xl bg-white border-slate-200 p-4">
                    ...
                    <a href="https://wa.me/+351?text=Ola,%20gostaria%20de%20agendar%20um%20horario."
                    target='_blank'
                    rel='noreferrer'
            ...
            <div className="rounded-xl bg-white border-slate-200 p-4">
                ...
                <a href="https://www.instagram.com/henriqueminucelli?igsh=anpkMDMwbjh0cWM5"
                target="_blank"
                rel="noreferrer"
            ...
            <div className="rounded-xl bg-white border-slate-200 p-4">
                ...
                <p>Horario de funcionamento por marcações</p>
                <p>Telefone : +351 000 000 000</p>
                <p>Email: seuEmail@.com</p>
            </div>
